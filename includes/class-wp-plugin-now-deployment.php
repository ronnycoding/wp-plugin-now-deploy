...
class Wp_Plugin_Now_Deployment {
	 ...
	 *
	 * - Wp_Plugin_Now_Deployment_Loader. Orchestrates the hooks of the plugin.
	 * - Wp_Plugin_Now_Deployment_i18n. Defines internationalization functionality.
	 * - Wp_Plugin_Now_Deployment_Admin. Defines all hooks for the admin area.
	 * - Wp_Plugin_Now_Deployment_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Wp_Plugin_Now_Deployment_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
